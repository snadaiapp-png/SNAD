...
MANDATORY_TESTS = [
    ...
    "AuditAutomaticDenialPersistenceIntegrationTest",
    "AuditFirstWriteConcurrencyIntegrationTest",
    "AuditHashChainConcurrencyIntegrationTest",
    "AuditTransactionBoundaryIntegrationTest",
    "IdempotencyAtomicReservationIntegrationTest",
    "IdempotencyLeaseFencingIntegrationTest",
    "IdempotencyProcessingLeaseIntegrationTest",
    "IdempotencyAtomicBusinessCompletionIntegrationTest",
