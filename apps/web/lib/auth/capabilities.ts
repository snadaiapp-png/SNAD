...
export const HRM_CAPABILITIES = {
  ...
  // === G1 Recruitment & Onboarding capabilities (added by G1-T11) ===
  // Source of truth: HrRecruitmentV2Controller + HrOnboardingV2Controller
  // backend capability annotations. The backend remains authoritative;
  // these constants only drive UI element hiding.
