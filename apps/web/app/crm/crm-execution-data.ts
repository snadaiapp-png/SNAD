...
export const EXECUTION_GROUPS: ExecutionGroup[] = [
  ...
  { code: "G1", titleAr: "قاعدة البيانات والأساس متعدد المستأجرين", titleEn: "Database & Multi-Tenant Foundation", purposeAr: "إنشاء جداول CRM الأساسية، العلاقات، العزل بين المؤسسات.", purposeEn: "Create core CRM tables, relations, tenant isolation.", status: "APPROVED", dependencies: ["G0"], canParallelizeWith: ["G2"], stageReport: "G1-STAGE-REPORT-V1 — معتمدة. 8 جداول، 26 فهرسًا، 8 علاقات مستأجر، عزل متعدد المستأجرين متحقق. الإنتاج: CRM-G1G2-CERTIFIED." },
  { code: "G2", titleAr: "التدويل وRTL/LTR وهيكلة الواجهة", titleEn: "i18n, RTL/LTR & UI Shell", purposeAr: "دعم العربية والإنجليزية، RTL وLTR.", purposeEn: "Support Arabic/English, RTL/LTR.", status: "APPROVED", dependencies: ["G0"], canParallelizeWith: ["G1"], stageReport: "G2-STAGE-REPORT-V1 — معتمدة. 304 مفتاح ترجمة، RTL/LTR، رموز الهوية. الإنتاج: CRM-G1G2-CERTIFIED." },
