...
const GROUPS: readonly G2LauncherGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/hr/leave", labelMessageId: "hrm.g2.landing.leave", descriptionMessageId: "hrm.leave.subtitle", capabilitiesAny: [HRM_CAPABILITIES.LEAVE_SELF_VIEW, HRM_CAPABILITIES.LEAVE_SELF_REQUEST], testId: "g2-launcher-leave" },
    ],
  },
  {
    id: "team",
    ...
    items: [
      ...
      { href: "/hr/leave/approvals", labelMessageId: "hrm.g2.landing.leaveApprovals", descriptionMessageId: "hrm.leaveApprovals.subtitle", capabilitiesAny: [HRM_CAPABILITIES.LEAVE_TEAM_APPROVE], testId: "g2-launcher-team-leave-approvals" },
      { href: "/hr/reports/attendance", labelMessageId: "hrm.g2.landing.attendanceReport", descriptionMessageId: "hrm.attendanceReport.subtitle", capabilitiesAny: [HRM_CAPABILITIES.ATTENDANCE_TEAM_VIEW], testId: "g2-launcher-team-attendance-report" },
    ],
  },
  {
    id: "hr",
    ...
    items: [
      ...
      { href: "/hr/leave/policies", labelMessageId: "hrm.g2.landing.leavePolicies", descriptionMessageId: "hrm.leavePolicies.subtitle", capabilitiesAny: [HRM_CAPABILITIES.LEAVE_POLICY_ADMIN], testId: "g2-launcher-leave-policies" },
      { href: "/hr/leave/approvals", labelMessageId: "hrm.g2.landing.leaveApprovals", descriptionMessageId: "hrm.leaveApprovals.subtitle", capabilitiesAny: [HRM_CAPABILITIES.LEAVE_HR_APPROVE], testId: "g2-launcher-hr-leave-approvals" },
      { href: "/hr/reports/attendance", labelMessageId: "hrm.g2.landing.attendanceReport", descriptionMessageId: "hrm.attendanceReport.subtitle", capabilitiesAny: [HRM_CAPABILITIES.ATTENDANCE_ADMIN], testId: "g2-launcher-hr-attendance-report" },
    ],
  },
];
...
export function HrG2Launcher({ capabilities }: { capabilities: string[] }) {
  const { t } = useI18n();
  const visibleGroups = GROUPS.map((group) => ({ ...group, items: group.items.filter((item) => isVisible(item, capabilities)) })).filter((group) => group.items.length > 0);
