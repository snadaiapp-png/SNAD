 ...
 * ---------------------
 * Implements the ExecutionProvider interface for the HR module.
 ...
 * HR Execution Provider
 *
 * Satisfies the ExecutionProvider interface for the HR module.
 * All execution logic uses the shared framework calculators and validators.
 */
export class HrExecutionProvider {
  readonly moduleId = "HR";
  readonly moduleName = "Human Resources";
  ...
  private buildProgram(): ExecutionProgram {
    ...
    return {
      ...
      titleEn: "Human Resources Management System",
      descriptionAr: "نظام شامل لإدارة الموظفين والتوظيف والحضور والأداء والرواتب",
      descriptionEn: "Comprehensive system for managing employees, recruitment, attendance, performance, and payroll",
      status,
      groups,
    };
  }
  ...
  private buildTask(taskData: HrTask): ExecutionTask {
    return {
      id: taskData.id,
