...
public final class RecruitmentCapabilities {
    ...
    public static final String APPLICATION_SUBMIT = "HRM.RECRUITMENT.APPLICATION.SUBMIT";
    public static final String APPLICATION_WITHDRAW = "HRM.RECRUITMENT.APPLICATION.WITHDRAW";
    ...
    public static final String OFFER_ACCEPT = "HRM.RECRUITMENT.OFFER.ACCEPT";
    public static final String OFFER_DECLINE = "HRM.RECRUITMENT.OFFER.DECLINE";
    ...
    private static final Set<String> ALL = Set.of(
            ...
            APPLICATION_MANAGE, APPLICATION_SUBMIT, APPLICATION_WITHDRAW,
            APPLICATION_ADVANCE, APPLICATION_REJECT,
            INTERVIEW_MANAGE, INTERVIEW_SCHEDULE, INTERVIEW_RECORD_OUTCOME,
            OFFER_MANAGE, OFFER_ACCEPT, OFFER_DECLINE, OFFER_EXTEND, OFFER_APPROVE,
            HIRE_CONVERT);
