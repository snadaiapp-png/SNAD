...
/** Repository for transfer requests and their steps (tenant-scoped). */
public interface TransferRequestRepository {
    ...
    TransferStep addStep(UUID tenantId, UUID transferRequestId, int stepNumber, UUID approverUserId);
