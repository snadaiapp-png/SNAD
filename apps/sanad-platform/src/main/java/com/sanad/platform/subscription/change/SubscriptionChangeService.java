...
public class SubscriptionChangeService {
    ...
    public ChangePreview preview(UUID subscriptionId, UUID targetPlanVersionId,
        ...
        Optional<SubscriptionItemEntity> planItem = ctx.planId() != null
                ...
                : Optional.empty();
        // R0C-6 authority: quantity mirrors seat_quantity, while
        // unit_amount_minor remains the pinned plan-price snapshot exposed by preview.
        // Multiplying the snapshot by the mirror here would double-apply seats for
        // FLAT plans and violate the certified PG-25 contract.
