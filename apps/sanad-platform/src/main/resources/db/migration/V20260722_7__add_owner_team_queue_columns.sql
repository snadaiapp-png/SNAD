...
CREATE INDEX idx_crm008b_accounts_owner_team
    ON crm_accounts (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_accounts_owner_queue
    ON crm_accounts (tenant_id, owner_queue_id);

CREATE INDEX idx_crm008b_contacts_owner_team
    ON crm_contacts (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_contacts_owner_queue
    ON crm_contacts (tenant_id, owner_queue_id);

CREATE INDEX idx_crm008b_leads_owner_team
    ON crm_leads (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_leads_owner_queue
    ON crm_leads (tenant_id, owner_queue_id);

CREATE INDEX idx_crm008b_opportunities_owner_team
    ON crm_opportunities (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_opportunities_owner_queue
    ON crm_opportunities (tenant_id, owner_queue_id);

CREATE INDEX idx_crm008b_activities_owner_team
    ON crm_activities (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_activities_owner_queue
    ON crm_activities (tenant_id, owner_queue_id);

CREATE INDEX idx_crm008b_tasks_owner_team
    ON crm_tasks (tenant_id, owner_team_id);

CREATE INDEX idx_crm008b_tasks_owner_queue
