...
CREATE INDEX idx_crm_accounts_tenant_owner_team
    ON crm_accounts (tenant_id, owner_team_id);

CREATE INDEX idx_crm_accounts_tenant_owner_queue
    ON crm_accounts (tenant_id, owner_queue_id);

CREATE INDEX idx_crm_contacts_tenant_owner_team
    ON crm_contacts (tenant_id, owner_team_id);

CREATE INDEX idx_crm_contacts_tenant_owner_queue
    ON crm_contacts (tenant_id, owner_queue_id);

CREATE INDEX idx_crm_leads_tenant_owner_team
    ON crm_leads (tenant_id, owner_team_id);

CREATE INDEX idx_crm_leads_tenant_owner_queue
    ON crm_leads (tenant_id, owner_queue_id);

CREATE INDEX idx_crm_opportunities_tenant_owner_team
    ON crm_opportunities (tenant_id, owner_team_id);

CREATE INDEX idx_crm_opportunities_tenant_owner_queue
    ON crm_opportunities (tenant_id, owner_queue_id);

CREATE INDEX idx_crm_activities_tenant_owner_team
    ON crm_activities (tenant_id, owner_team_id);

CREATE INDEX idx_crm_activities_tenant_owner_queue
    ON crm_activities (tenant_id, owner_queue_id);

CREATE INDEX idx_crm_tasks_tenant_owner_team
    ON crm_tasks (tenant_id, owner_team_id);

CREATE INDEX idx_crm_tasks_tenant_owner_queue
