-- CRM Contact Create production reconciliation after a verified Flyway baseline gap.
-- Forward-only and idempotent: restores the schema contract originally introduced by V20260717_1.
-- Do not edit flyway_schema_history and do not use flyway repair.
...
-- Legacy compatibility remains read/write until all callers use the canonical relationship model.
