...
class PlatformApiCountTest {
    ...
    /** 357 original - 35 control-plane + 37 executive (incl. 10 Mission 01) + 4 system-health + 52 CRM v2 growth + 6 Mission 02 lifecycle/reset + 25 Senior Management = 446. */
    private static final long EXPECTED_TOTAL_OPS = 446;
