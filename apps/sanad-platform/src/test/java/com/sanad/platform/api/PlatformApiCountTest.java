...
class PlatformApiCountTest {
    ...
    /** 517 (previous) + 18 Finance module endpoints (accounts create+list+get+deactivate+archive, invoices create+list+get+issue+cancel+mark-paid, payments create+list+get+complete+fail+refund, quota) = 535. */
    private static final long EXPECTED_TOTAL_OPS = 535;
