 ...
 *
 * <p>Requires PostgreSQL (PostgreSQL 16) because the atomic CTE claim uses
...
class CrmIntegrationOutboxWorkerTest {
    ...
    @BeforeAll
    static void setup() {
        boolean postgresAvailable = Crm009TestEnvironment.requirePostgreSqlDirectOrSkip("CrmIntegrationOutboxWorkerTest");
