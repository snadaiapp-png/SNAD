...
| `20260722.1` | `V20260722_1__create_crm_sales_teams.sql` | CRM-008B: Sales teams and team memberships | `IN_PROGRESS` (`#691`) |
| `20260722.2` | `V20260722_2__create_crm_queues.sql` | CRM-008B: Queues and queue memberships | `IN_PROGRESS` (`#691`) |
| `20260722.3` | `V20260722_3__create_crm_territories.sql` | CRM-008B: Territories, closure table, and territory assignments | `IN_PROGRESS` (`#691`) |
| `20260722.4` | `V20260722_4__create_crm_assignment_rules.sql` | CRM-008B: Assignment rules and rule versions | `IN_PROGRESS` (`#691`) |
| `20260722.5` | `V20260722_5__create_crm_assignments.sql` | CRM-008B: Extend crm_assignments + create ownership history | `IN_PROGRESS` (`#691`) |
| `20260722.6` | `V20260722_6__create_crm_transfer_requests.sql` | CRM-008B: Transfer requests and transfer steps | `IN_PROGRESS` (`#691`) |
| `20260722.7` | `V20260722_7__add_owner_team_queue_columns.sql` | CRM-008B: Add owner_team_id, owner_queue_id to 6 CRM tables | `IN_PROGRESS` (`#691`) |
| `20260722.8` | `V20260722_8__seed_crm_ownership_capabilities.sql` | CRM-008B: Seed 17 capabilities + assign to ADMIN roles | `IN_PROGRESS` (`#691`) |
| `20260722.9` | `V20260722_9__create_crm_assignment_rule_counters.sql` | CRM-008B: Round-robin counter table | `IN_PROGRESS` (`#691`) |
