...
| `20260717.4` | `V20260717_6__crm_addresses_communication_methods.sql` | Canonical owner-scoped addresses, communication methods, history, policies and legacy backfill | `IN_PROGRESS` |
| `20260717.7` | `V20260717_7__crm_addresses_communication_capabilities.sql` | Address, communication, sensitive-read and export capabilities | `IN_PROGRESS` |
