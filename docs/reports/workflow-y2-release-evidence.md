...
| Version | File |
|---------|------|
| V20260902_1 | workflow_y2_identity_and_capabilities |
| V20260902_2 | workflow_y2_definition_graph |
| V20260902_3 | workflow_y2_work_items_approvals |
| V20260902_4 | workflow_y2_runtime_context |
| V20260902_5 | workflow_y2_sla_incidents_execution |
| V20260902_6 | workflow_y2_events_notifications |
| V20260902_7 | workflow_break_glass_override |
...
**COLLISION DETECTED = NO (RESOLVED)**

Original V20260830_1/2 collided with main's SCP migrations. All 7 workflow
migrations have been renumbered to V20260902_1..7 (after main's latest
V20260901_1). SQL content unchanged (filename/version metadata only).
FlywayDuplicateVersionGuardTest added to prevent recurrence.

VERIFIED: CI run 33691855053 (a6278bb5) — Maven ✓ + PG Acceptance ✓ + CRM ✓
